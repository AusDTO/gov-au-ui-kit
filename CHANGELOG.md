...
- Callouts:
  - extends with a new class to highlight specific dates (`.callout--calendar-event`).
  - extends with a new class to add a reminder for upcoming events (`.callout--reminder`).
